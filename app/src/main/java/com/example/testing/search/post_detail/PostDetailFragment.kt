...
class PostDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = CustomDialogOpenImageviewBinding.inflate(layoutInflater, container, false)

        val homePostBundle = arguments
//        val searchPostBundle = arguments

        val homeUserImage = homePostBundle?.getString("User_Image")
        Glide.with(requireContext()).load(homeUserImage).into(binding.customZoomImageView)
